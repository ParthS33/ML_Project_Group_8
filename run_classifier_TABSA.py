...
def main():
    ...
    if args.output_dir:
        args.output_dir = args.output_dir +"_" + str(args.max_seq_length) + "_" + str(args.train_batch_size) + "_" + str(args.learning_rate) + "_" + str(args.num_train_epochs) +\
        "_" + str(args.gradient_accumulation_steps) + "_" + str(args.accumulate_gradients)
